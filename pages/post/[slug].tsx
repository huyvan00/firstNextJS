...
import Portable from 'react-portable-text'
        ...
        <main>
            ...
            <article className='max-w-3xl mx-auto p-5'>
                ...
                <div className='flex items-center space-x-2'>
                    ...
                    <p className='font-extralight text-sm'>Blog post by <span className='text-green-500'>{post.author.name}</span> - Published at
                ...
                <form onSubmit={handleSubmit(onSubmit)} className='flex flex-col p-5 max-w-2xl mx-auto mb-10'>
                    ...
                    <label className='block mb-5'>
                        ...
                        <input
                            ...
                            className='shadow border rounded py-2 px-3 form-input mt-1 block w-full ring-yellow-500 outline-none focus:ring' placeholder='John Snow' type='text' />
                    </label>
                    <label className='block mb-5'>
                        <span className='text-gray-700'>Email</span>
                        <input
                            {...register('email', { required: true })}
                            className='shadow border rounded py-2 px-3 form-input mt-1 block w-full ring-yellow-500 outline-none focus:ring' placeholder='John Snow'
                            type='email' />
                    </label>
                    <label className='block mb-5'>
                     ...
                     block w-full ring-yellow-500 outline-none focus:ring' placeholder='Write comment here' rows={8} />
                    </label>
                    {/* error */}
...
export const getStaticProps: GetStaticProps = async ({ params }) => {
    ...
    return {
        ...
        revalidate: 60, // after 60 seconds reload pages
    }
}
