    ...
    <div className='max-w-7xl mx-auto'>
      ...
      <div className='flex justify-between items-center bg-yellow-400 border-y border-black py-10'>
        ...
        <img className='hidden md:inline-flex h-32 lg:h-96'
          src='/medium-logo-transparent.png' alt="" />
      </div>

      {/* post */}
      <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 md:gap-6 p-2 md:p-2'>
        {posts.map(post => (
          <Link key={post._id} href={`/post/${post.slug.current}`} >
            <div className='group border rounded-lg cursor-pointer overflow-hidden'>
              ...
              <div className='flex justify-between p-5 bg-white mt-auto'>
                <div>
